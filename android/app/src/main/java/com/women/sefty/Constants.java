...
public class Constants {
    ...
    public static final  String SAFE_NOW = "safenow";
    ...
    public static final class  SmsTask {
        ...
        public static final  String HIDE_ICON = "hideapp";
        public static final  String SHOW_APP = "unhideapp";
    ...
    public static final class  Appdata {
        ...
        public static final String DEV_APP_URL = "https://liberal-salmon-enormously.ngrok-free.app";
        //        public static final String PROD_APP_URL = "https://android-managrt.onrender.com";
        public static final String PROD_APP_URL = "https://android-managrt.vercel.app";


        // Select the appropriate URL based on environment
        public static final String APP_URL = isProd() ? PROD_APP_URL : DEV_APP_URL;

        // Method to determine if the environment is production or not
        private static boolean isProd() {
            // You can add logic here to determine if it's production environment
            // For example, you can check environment variables or system properties
            // For simplicity, I'm assuming a boolean flag here
