...
const SplashView: React.FC<Props> = ({ onNextClick, animationController }) => {
  ...
  const introImageData = Image.resolveAssetSource(ImageConstant.onBoardOne);
      ...
      <ScrollView style={{ flexGrow: 0 }} alwaysBounceVertical={false}>
        <View>
          <Image
            ...
            source={ImageConstant.onBoardTwo}
          />
        </View>
        <Text style={styles.title}>{appContent.start_learning}</Text>
        <Text style={styles.subtitle}>
        {appContent.onboard_one_description}
        </Text>
      </ScrollView>
